...
from utils.dataloader import data_generator, process_raw_data
...
train_data = data_generator(process_raw_data(), tokenizer, max_len=con.getint("para", "maxlen"), schema=schema)
